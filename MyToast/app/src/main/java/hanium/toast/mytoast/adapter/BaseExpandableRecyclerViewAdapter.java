...
public abstract class BaseExpandableRecyclerViewAdapter
    ...
    protected int getChildType(GroupBean groupBean, MyLCCompleteChild childBean) {
        return 0;
    }
     ...
     * @param childBean
     */
    abstract public void onBindChildViewHolder(ChildViewHolder holder, GroupBean groupBean, MyLCCompleteChild childBean);
     ...
     * @param payload
     */
    protected void onBindChildViewHolder(ChildViewHolder holder, GroupBean groupBean, MyLCCompleteChild childBean, List<Object> payload) {
   ...
   /* public void setHeaderViewProducer(ViewProducer headerViewProducer, boolean showWhenEmpty) {
    ...
    protected void bindChildViewHolder(ChildViewHolder holder, final GroupBean groupBean, final MyLCCompleteChild childBean, final List<Object> payload) {
    ...
    public interface BaseGroupBean<ChildBean> {
         ...
         * @return
         */
        MyLCCompleteChild getChildAt(int childIndex);
